...
class AssetDropdown extends React.Component {
    ...
    render() {
        return (
          <div className="align-items-center" style={{background:"#202943"}}>
          <DropdownButton variant="dark" className="ml-2 pt-1 pb-1"  size="sm" title={this.props.product} onSelect={this.handleSelect = (evt) => {  
            const payload = evt;
            this.props.setProduct(payload);}}>
